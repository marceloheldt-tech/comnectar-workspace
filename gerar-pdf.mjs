...
const dir = 'C:/Users/marce/Desktop/claude comnéctar/conteudo/catalogos/2026-08-25-espanhois-andre';
...
writeFileSync(`${dir}/Selecao Espanhola - Andre.pdf`, output);
console.log('\n✅ PDF gerado: Selecao Espanhola - Andre.pdf');
