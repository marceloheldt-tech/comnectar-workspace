...
const dir = 'C:/Users/marce/Desktop/claude comnéctar/conteudo/catalogos/2026-09-10-leandro-guarda';
...
writeFileSync(`${dir}/Selecao Leandro - Vinhos de Guarda.pdf`, output);
console.log('\n✅ PDF gerado: Selecao Leandro - Vinhos de Guarda.pdf');
