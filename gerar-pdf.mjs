...
const dir = 'C:/Users/marce/Desktop/claude comnéctar/conteudo/catalogos/2026-09-10-pierre-italia-franca';
...
writeFileSync(`${dir}/Selecao Pierre - Italia e Franca.pdf`, output);
console.log('\n✅ PDF gerado: Selecao Pierre - Italia e Franca.pdf');
