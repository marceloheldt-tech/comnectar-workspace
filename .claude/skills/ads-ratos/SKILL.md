...
Ao receber um sub-comando, ler o arquivo de instruções correspondente:
- `/ads-ratos setup` → ler `.claude/skills/ads-ratos/commands/setup.md`
- `/ads-ratos diagnostico` → ler `.claude/skills/ads-ratos/commands/diagnostico.md`
- `/ads-ratos relatorio` → ler `.claude/skills/ads-ratos/commands/relatorio.md`
- `/ads-ratos auditoria` → ler `.claude/skills/ads-ratos/commands/auditoria.md`
- `/ads-ratos historico` → ler `.claude/skills/ads-ratos/commands/historico.md`
